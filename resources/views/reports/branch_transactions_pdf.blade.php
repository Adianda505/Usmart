...
<body>
    ...
    <div class="header">
        <h2>Laporan Transaksi Cabang</h2>
        <p>Menampilkan data transaksi berdasarkan cabang {{ strtolower($roleTitle) }} yang sedang login</p>
    </div>

    <div class="info">
        <table>
            <tr>
                <td class="label">Nama {{ $roleTitle }}</td>
                <td>: {{ $user->name }}</td>
            </tr>
            <tr>
    ...
    <div class="footer">
        Laporan Transaksi Cabang - {{ config('app.name') }}
    </div>
