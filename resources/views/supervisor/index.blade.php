        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Kelola data akun supervisor pada setiap cabang
                </p>
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('owner.users.supervisor.exportPdf') }}"
    ...
    <div class="p-6">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div class="px-6 py-5 border-b border-gray-100 bg-gray-50">
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Menampilkan seluruh akun supervisor beserta cabang yang terhubung
                </p>
            </div>
                ...
                <table class="w-full text-sm text-left text-gray-600">
                    ...
                    <thead class="bg-slate-900 text-white uppercase text-xs tracking-wider">
                        <tr>
                            ...
                            <th class="px-6 py-4 font-semibold">Nama Supervisor</th>
                        ...
                        @forelse($supervisors as $supervisor)
                            <tr class="hover:bg-slate-50 transition duration-150">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <span
                                        class="inline-flex px-3 py-1 text-xs font-medium rounded-full bg-green-50 text-green-700 border border-green-100">
                                ...
                                <td colspan="6" class="px-6 py-14 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-gray-400 text-sm mt-1">
                                            Silakan tambahkan akun supervisor terlebih dahulu.
                                        </p>
                                    </div>
                                </td>
                            </tr>
