<x-app-layout>
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Kelola riwayat pergerakan stok produk pada setiap cabang
                </p>
            </div>
    ...
    <div class="p-6">
        ...
        {{-- Alert Error --}}
        @if(session('error'))
            <div class="mb-5 flex items-center gap-3 p-4 bg-red-50 border border-red-200 text-red-700 rounded-xl shadow-sm">
                            ...
                            <tr class="hover:bg-slate-50 transition duration-150">
                                ...
                                <td class="px-6 py-4 text-center">
                                    @if($movement->type == 'masuk')
                                        <span class="inline-flex px-3 py-1 text-xs font-semibold rounded-full bg-green-50 text-green-700 border border-green-100">
                                            Masuk
                                        </span>
                                    @else
                                        <span class="inline-flex px-3 py-1 text-xs font-semibold rounded-full bg-red-50 text-red-700 border border-red-100">
                                            Keluar
                                        </span>
                                    @endif
                                </td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <span class="inline-flex items-center justify-center min-w-10 px-3 py-1 rounded-full bg-slate-100 text-slate-700 font-semibold">
                                        {{ $movement->qty }}
                                    </span>
                                </td>
